...
module.exports = class Project {
    ...
    createSchema(){
        return new Promise(function (fulfil,reject){
            ...
            try{
                fs.copyFileSync(Schema.gallactic_path +Schema.template + Schema.config_file, Schema.project_path + Schema.config_file);
                ...
                fs.copyFileSync(Schema.gallactic_path +Schema.template + Schema.account_list, Schema.project_path + Schema.accounts + Schema.account_list);
                fs.copyFileSync(Schema.gallactic_path +Schema.template + Schema.default_account, Schema.project_path + Schema.accounts + Schema.default_account);
